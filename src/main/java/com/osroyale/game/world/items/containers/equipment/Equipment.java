...
public final class Equipment extends ItemContainer {
    ...
    public void openInterface() {
        ...
        player.send(new SendString("Melee max hit: " + player.playerAssistant.getMaxHit(player, CombatType.MELEE) + "</col>", 15116));
        player.send(new SendString("Ranged max hit: " + player.playerAssistant.getMaxHit(player, CombatType.RANGED) + "</col>", 15117));
        player.send(new SendString("Drop rate bonus: +0%", 15118));
